...
void printBacktrace()
{
    // credits: http://panthema.net/2008/0901-stacktrace-demangled/

    const unsigned int max_frames = 63;
    std::cerr
        << std::endl
        << "_____ STACK TRACE BEGIN _______________________" << std::endl;
    ...
    std::cerr << "_____ STACK TRACE END _________________________" << std::endl;
    std::cout << std::endl;
